...
sceDefaults <- function()
    list(ncomplex = 10, cce.iter = NA, fnscale = 1, elitism = 1,
      initsample = "latin", reltol = 1e-7, tolsteps = 7, maxit = 1000,
      maxeval = Inf, maxtime = Inf, returnpop = FALSE, trace = 0, REPORT = 1)
